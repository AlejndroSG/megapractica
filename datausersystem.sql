...
insert into recipe values (020, 'Tarta de limón', 'pedrosanchez', 'Tarta refrescante con una cremosa y ácida mezcla de limón', 'Galletas, mantequilla, leche condensada, huevos, jugo de limón, ralladura de limón', '1. Tritura las galletas hasta obtener migas finas. 2. Mezcla las migas de galleta con mantequilla derretida y presiona en el fondo de un molde para tarta. 3. En un bol, bate la leche condensada con los huevos, el jugo y la ralladura de limón. 4. Vierte la mezcla sobre la base de galleta. 5. Hornea durante 20-25 minutos a 180°C o hasta que esté firme. 6. Deja enfriar antes de refrigerar durante al menos 2 horas. 7. Sirve frío, decorado con rodajas de limón y crema batida si lo deseas.');
...
(
    ...
    cod             number(3,0),
    nombreR         varchar2(50) unique not null,
    constraint ce_tag_cod foreign key(cod)
        references recipe(cod),
    constraint ce_tag_nom foreign key(nombreR)
        references recipe(nombreR)
);
